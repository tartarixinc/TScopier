          ...
          {filters.map(f => (
            <button
              ...
              className={`px-3 py-1.5 text-xs rounded-md font-medium transition-colors ${
                filter === f.value ? 'bg-teal-600 text-white' : 'text-neutral-600 hover:bg-neutral-100'
              }`}
            >
              {f.label}
            </button>
      ...
      <Card padding="none">
        ...
        {loading ? (
          ...
          <div className="py-20 text-center">
            <div className="w-16 h-16 bg-neutral-100 rounded-2xl mx-auto mb-3 flex items-center justify-center">
