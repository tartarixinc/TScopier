export const DASHBOARD_CACHE_VERSION = 'dashboard_cache_v19'
export const DASHBOARD_CACHE_LEGACY_KEYS = ['dashboard_cache_v18', 'dashboard_cache_v17', 'dashboard_cache_v16', 'dashboard_cache_v15', 'dashboard_cache_v11', 'dashboard_cache_v10', 'dashboard_cache_v9', 'dashboard_cache_v8', 'dashboard_cache_v7'] as const
