...
export const accountConfigSv: AccountConfigBundleTranslations = {
  accountConfig: {
    ...
    connectForm: {
      ...
      connectingStepLinking: 'Länkar ditt MT5-konto…',
      connectingStepTerminal: 'Startar din MT5-terminal — detta tar vanligtvis 10–30 sekunder.',
    ...
    bulkConnect: {
      ...
      uploadHint: 'Släpp en CSV-fil här eller klicka för att bläddra',
