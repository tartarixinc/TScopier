...
export const en: Translations = {
  ...
  dashboard: {
    ...
    tradeActivities: 'Trade Activities',
    tradeActivitiesHint:
      'Live trade actions from your signal channels — orders, stop-loss updates, breakeven moves, and closes. Retry failed actions from Activities.',
  ...
  management: {
    ...
    emptySubtitle: 'Trade activities will appear here once your copier executes actions from signal channels.',
