...
export const en: Translations = {
  ...
  dashboard: {
    ...
    todaysProfitHint:
      'Net realized P/L from trades closed today (local calendar day, by close time).',
    ...
    brokerStats: {
      ...
      initialBalanceHint: 'Balance when this account was first linked to TSCopier.',
      ...
      lastSignalTradeHint:
        'Most recent closed trade linked to a Telegram signal channel, with lifetime P/L for that channel.',
      noLastSignalTrade: 'No attributed signal-channel trades in history.',
      channel: 'Channel',
      symbol: 'Symbol',
      lastSignalChannelProfit: 'Channel total P/L',
      profit: 'Profit',
      closedAt: 'Closed',
    },
  },
