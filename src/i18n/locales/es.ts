...
export const es: Translations = {
  ...
  accountConfig: {
    ...
    connectForm: {
      ...
      brokerServerHint:
        'Busca por nombre de la empresa broker y elige tu servidor, igual que en MetaTrader.',
      brokerCompanySearchPlaceholder: 'Introduce el nombre de la empresa (p. ej. IC Markets)',
  ...
  dashboard: {
    ...
    brokerStats: {
      ...
      initialBalanceHint: 'Saldo cuando esta cuenta se vinculó por primera vez a TSCopier.',
