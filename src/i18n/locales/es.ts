...
export const es: Translations = {
  ...
  accountConfig: {
    ...
    connectForm: {
      ...
      brokerCompanySearchPlaceholder: 'Introduce el nombre de la empresa (p. ej. Vantage)',
      brokerCompanySearchEmpty: 'Usa la búsqueda para encontrar una empresa',
  ...
  signalHistoryPage: {
    ...
    totalFound: 'Total encontrado: {count}',
    noSignals: 'No hay señales para los filtros seleccionados.',
    updatesReceivedToday: 'Actualizaciones recibidas (Hoy)',
    updatesReceivedLast7d: 'Actualizaciones recibidas (Últimos 7 días)',
    updatesReceivedLast30d: 'Actualizaciones recibidas (Últimos 30 días)',
    updatesReceivedTotal: 'Actualizaciones recibidas (Total)',
    updatesReceivedThisWeek: 'Actualizaciones recibidas (Esta semana)',
    updatesReceivedThisMonth: 'Actualizaciones recibidas (Este mes)',
  },
  trades: {
    title: 'Operaciones',
