...
export const channelWorkerEs: ChannelWorkerTranslations = {
  ...
  rangeRebalanceSkippedGeneric: 'Se omitió el rebalanceo de take profit ({reason})',
  rangeRebalanceFailedNamed: 'No se pudo rebalancear el take profit {on}',
  rangeRebalanceFailedGeneric: 'No se pudo rebalancear el take profit de tu operación abierta',
  errorTicketNotFound: 'Ticket {ticket} no encontrado',
  errorSymbolNotFound: 'Símbolo no encontrado: {symbol}',
  errorBrokerRejectedGeneric: 'El bróker rechazó esta orden — revisa el mapeo de símbolos y la conexión, luego inténtalo de nuevo',
