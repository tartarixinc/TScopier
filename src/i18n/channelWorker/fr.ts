...
export const channelWorkerFr: ChannelWorkerTranslations = {
  ...
  rangeRebalanceSkippedGeneric: 'Rééquilibrage du take profit ignoré ({reason})',
  rangeRebalanceFailedNamed: 'Impossible de rééquilibrer le take profit {on}',
  rangeRebalanceFailedGeneric: 'Impossible de rééquilibrer le take profit sur votre opération ouverte',
  ...
  errorTradeEaNotReady:
    'L’EA de trading n’est pas prêt sur votre terminal MT5 — activez Algo Trading, gardez le terminal ouvert, puis actualisez la santé du courtier',
