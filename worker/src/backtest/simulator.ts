export interface MassiveBar { t: number; o: number; h: number; l: number; c: number; v?: number }
export interface MassiveQuote { participant_timestamp: number; bid_price: number; ask_price: number }
import type {
