...
exports.BROKER_SESSION_HEARTBEAT_MS = Math.max(5000, Math.min(60000, Number(process.env.BROKER_SESSION_HEARTBEAT_MS ?? 15000)));
exports.SESSION_PING_MIN_INTERVAL_MS = Math.max(5000, Math.min(120000, Number(process.env.BROKER_SESSION_PING_MIN_INTERVAL_MS ?? exports.BROKER_SESSION_HEARTBEAT_MS)));
exports.EXECUTOR_PARSED_SWEEP_MS = (0, monitorIdleGate_1.monitorActiveIntervalMs)('EXECUTOR_PARSED_SWEEP_MS', 3000);
